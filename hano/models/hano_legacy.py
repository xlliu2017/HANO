...
class SpectralConv2d(nn.Module):
    """2D spectral convolution used in the legacy HANO decoder."""
...
class Decodermap(nn.Module):
    """Legacy FNO-style decoder that maps latent features back to output fields."""
...
class HAttention(nn.Module):
    """Legacy hierarchical window-attention encoder."""
...
class HANO2d(nn.Module):
    """Legacy Hierarchical Attention Neural Operator."""
...
class HANO(HANO2d):
    """Legacy compatibility alias for HANO implementations expecting `HANO`."""
